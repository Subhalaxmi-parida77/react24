  ...
  return (
    <section className="testimonials">
      <div className="py-12 px-6 ">
        <h2 className="text-center pt-12 text-3xl mb-8 font-extrabold">Testimonials</h2>
        <div className="max-w-[80rem] lg:max-w-[90rem] mx-auto bg-white rounded-md shadow-lg p-6 mb-10">
          <div className="flex flex-col md:flex-row items-center w-full">
            <div className="w-32 h-60 md:w-40 md:h-80  lg:w-52 lg:h-96 mb-4 md:mb-0">
              ...
              />
              <h3 class="text-xl sm:text-xl md:text-3xl font-semibold text-gray-800 mt-6 font-bold">
                Aliceano Colby
              </h3>
            ...
            <div class="md:ml-6 text-center md:text-left " >
				<p className="text-3xl font-bold"> Awesome Work</p>
